---
name: review
description: "Review staged changes or recent commits for bugs, security issues, and style. Use when user says 'review my code', 'check my changes', 'review trước khi commit', or asks for a code review of local changes."
